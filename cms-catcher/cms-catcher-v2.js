...
const getMainUrl = server => {
  ...
  return `https://ann-api.mihoyo.com/common/bh2_cn/announcement/api/getAnnList?game=bh2&game_biz=bh2_cn&lang=zh-cn&region=gf01&platform=ios&bundle_id=com.miHoYo.HSoDv2CN`
}
